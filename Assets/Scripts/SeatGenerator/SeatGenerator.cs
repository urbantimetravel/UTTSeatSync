...
namespace UrbanTimetravel.SeatSync
{
    ...
    public class SeatGenerator : MonoBehaviour
    {
        ...
        /// Enable a seat
        /// </summary>
        /// <param name="value">Seat number. Starts at 0.</param>
        ...
        /// <summary>
        /// Place the player camera to the seat position
        /// </summary>
        /// <param name="value">Seat number. Starts at 0.</param>
        ...
        /// <summary>
        /// Generates the QR codes and stores them in the qr codes folder.
        /// </summary>
        /// <param name="text">The seat number as string.</param>
        ...
        /// <summary>
        /// Remove all seats and clear the list
        /// </summary>
